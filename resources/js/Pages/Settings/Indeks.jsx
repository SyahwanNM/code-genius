        ...
        <UserLayout auth={auth}>
            ...
            <div className="max-w-4xl mx-auto px-6 lg:px-8 py-12 space-y-10">
                <header>
                    ...
                    <h1 className="text-4xl font-black mb-2 text-white italic uppercase tracking-tight">System <span className="text-accent">Settings</span></h1>
                        ...
                        <form onSubmit={submitPassword} className="rounded-3xl border border-white/5 bg-[#0D1117] p-8 lg:p-10 space-y-10">
                            <div>
                                <h2 className="text-xl font-black flex items-center gap-3 text-white italic uppercase">
                                    <Lock className="text-accent" size={22} /> Perbarui Password
                                </h2>
                            ...
                            <div className="space-y-8">
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        <Key size={16} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-700 group-focus-within:text-accent transition-colors" />
                                        <input
                                            type="password"
                                            className="w-full bg-white/[0.02] border border-white/10 rounded-2xl py-5 pl-14 pr-6 focus:border-accent outline-none transition-all text-sm text-white placeholder-gray-800"
                                    ...
                                    {passwordForm.errors.current_password && (
                                        <p className="text-accent text-[10px] font-black uppercase tracking-widest">{passwordForm.errors.current_password}</p>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative group">
                                            <Lock size={16} className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-700 group-focus-within:text-accent transition-colors" />
                                            <input
                                                type="password"
                                                className="w-full bg-white/[0.02] border border-white/10 rounded-2xl py-5 pl-14 pr-6 focus:border-accent outline-none transition-all text-sm text-white placeholder-gray-800"
                                        ...
                                        {passwordForm.errors.password && (
                                            <p className="text-accent text-[10px] font-black uppercase tracking-widest">{passwordForm.errors.password}</p>
                                        )}
                                    </div>
                                    <div className="space-y-3">
                            ...
                            <div className="flex justify-end pt-4">
                                <button
                                    ...
                                    className="px-12 py-5 bg-white text-black font-black uppercase tracking-widest text-[10px] rounded-2xl hover:bg-accent transition-all shadow-2xl shadow-accent/10 active:scale-95 disabled:opacity-50"
                                >
                ...
                {activeTab === 'notifications' && (
                    <div className="rounded-3xl border border-white/5 bg-[#0D1117] p-8 lg:p-10 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div>
                            <h2 className="text-xl font-black flex items-center gap-3 text-white italic uppercase">
                                <Bell className="text-accent" size={22} /> Push Notifications
                            </h2>
                        ...
                        <div className="space-y-2 divide-y divide-white/5">
                            {[
                                ...
                                <div key={i} className="flex items-center justify-between py-6 first:pt-0">
                                    ...
                                    <button className={`w-12 h-6 rounded-full transition-all relative shrink-0 ${notif.enabled ? 'bg-accent' : 'bg-white/10'}`}>
